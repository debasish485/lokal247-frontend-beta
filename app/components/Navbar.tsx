  ...
  return (
    <header
      className={`w-full z-50 absolute top-0 left-0 ${
        !isHomePage
          ? "bg-white border-b border-gray-200 h-[76px] px-[122px] py-[13px]"
          : "bg-transparent border-b border-white/30 h-20 px-4"
      }`}
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden bg-white border-t overflow-hidden transition-all ${
